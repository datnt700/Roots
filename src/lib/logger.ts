...
export const logger = {
  debug: (tag: string, message: string, ctx?: Context) =>
    log('debug', tag, message, ctx),
  info: (tag: string, message: string, ctx?: Context) =>
    log('info', tag, message, ctx),
  warn: (tag: string, message: string, ctx?: Context) =>
    log('warn', tag, message, ctx),
  error: (tag: string, message: string, ctx?: Context, err?: unknown) =>
    log('error', tag, message, ctx, err),
}
